...
const UpdateGroupDetails = () => {
  ...
  return (
    selectedChat && (
      <div className="absolute top-0 left-0 w-full h-screen px-2 flex items-center justify-center bg-zinc-900 opacity-90">
                    ...
                    <div
                      ...
                      className={`${
                        u._id === selectedChat.groupAdmin._id
                          ? "bg-green-300"
                          : "bg-blue-300"
                      } w-20 py-2 flex-shrink-0 flex gap-1 flex-col items-center justify-center rounded-md`}
                    >
              ...
              {!loading ? (
                ...
                users.map((user) => (
                  <div
                    ...
                    key={user._id}
                    className="user w-full px-4 py-2 flex items-center gap-2 border-b border-zinc-400 cursor-pointer"
                  >
