...
const HomePage = () => {
  ...
  return user ? (
    <div className="w-full h-screen flex bg-zinc-100">
      <SideNav />
      <div className="hidden sm:w-[50vw] md:w-[60vw] lg:w-[70vw] sm:flex flex-col items-center justify-center bg-zinc-100">
        <h1 className="text-[2rem] md:text-[2.75rem] lg:text-[3.5rem] font-bold tracking-tighter opacity-80 leading-none">
          Hello, {user.fullName} !
        </h1>
        <h4 className="text-[1.25rem] md:text-[1.5rem] lg:text-[1.75rem] font-semibold italic opacity-80">
