...
const ResetPasswordPage = () => {
  ...
  return (
    <div className="w-full h-screen bg-zinc-200 px-2 md:px-4">
      <div className="md:w-[50vw] lg:w-[30vw] mx-auto flex flex-col items-center gap-5">
        ...
        <form onSubmit={submitHandler} className="w-full flex flex-col gap-5">
          ...
          />
          <button className="w-full font-medium px-4 py-2 rounded-md text-base text-white bg-blue-500 hover:bg-blue-600 cursor-pointer">
            Change Password
          </button>
        </form>
      </div>
