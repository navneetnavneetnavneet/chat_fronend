...
const ForgotPasswordPage = () => {
  ...
  const submitHandler = async (e) => {
    ...
    toast.success("Email sent successfylly");
    setEmail("");
  };

  return (
    <div className="relative w-full h-screen bg-zinc-200 px-2 md:px-4">
      <div className="w-full md:w-[40vw] lg:w-[30vw] mx-auto flex flex-col items-center gap-y-5">
        ...
        <h1 className="text-[1.5rem] md:text-[2rem] font-semibold leading-none tracking-tighter">
          Trouble logging in?
        </h1>
        <p className="text-[1rem] md:text-[1.25rem] text-center opacity-80 leading-tight tracking-tighter">
        ...
        <form onSubmit={submitHandler} className="w-full flex flex-col gap-y-5">
          ...
          />
          <button className="w-full font-medium px-4 py-2 rounded-md text-base text-white bg-blue-500 hover:bg-blue-600">
            Send Link
          </button>
        </form>
